...
from aeon_neuro.testing.tests import ALL_AEON_NEURO_MODULES_NO_TESTS

if __name__ == "__main__":
    """Test imports in aeon-neuro modules with core dependencies only.

    Imports all modules and catch exceptions due to missing dependencies.
    """
    for module in ALL_AEON_NEURO_MODULES_NO_TESTS:
        try:
