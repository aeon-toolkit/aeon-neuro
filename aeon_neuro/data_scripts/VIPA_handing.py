...
testy = y[20:]
classNames = ["closed","open"]
write_to_tsfile(np.asarray(trainX),writeloc,"VIPA_Study_downsampled_TRAIN",classNames,np.asarray(trainy))
write_to_tsfile(np.asarray(testX),writeloc,"VIPA_Study_downsampled_TEST",classNames,np.asarray(testy))
