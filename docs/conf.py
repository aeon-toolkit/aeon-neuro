...
version = aeon_neuro.__version__
release = aeon_neuro.__version__
...
# Notebook thumbnails
nbsphinx_thumbnails = {  # TODO: update path
...
issues_github_path = "aeon-toolkit/aeon-neuro"
...
def linkcode_resolve(domain, info):
    ...
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(aeon_neuro.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "aeon-neuro/%s#L%d-L%d" % find_source()
    except Exception:
        filename = info["module"].replace(".", "/") + ".py"
    return "https://github.com/aeon-toolkit/aeon-neuro/blob/{}/{}".format(
        github_tag,
        filename,
    )
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/aeon-toolkit/aeon-neuro/",
    "source_branch": "main",
    ...
    "footer_icons": [
        {
            "name": "Slack",
            "url": "https://join.slack.com/t/aeon-neuro/shared_invite/zt-2k4qs8mjb-ZZs~6P0MdF8kGf9cUQzKSg",  # noqa: E501
            "html": """
        ...
        {
            "name": "GitHub",
            "url": "https://github.com/aeon-toolkit/aeon-neuro",
            "html": """
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            "name": "ReadTheDocs",
            "url": "https://readthedocs.org/projects/aeon-neuro/",
            "html": """
...
# logos: TODO make these aeon-neuro specific
...
htmlhelp_basename = "aeonneurodoc"
...
man_pages = [(master_doc, "aeon-neuro", "aeon-neuro Documentation", [author], 1)]
...
def _make_estimator_overview(app):
    ...
    pass  # TODO: add in aeon-neuro estimators
...
binder_url = f"https://mybinder.org/v2/gh/aeon-toolkit/aeon-neuro/{github_tag}?filepath={current_file}"  # noqa
nbsphinx_prolog = f"""
...
notebook_url = (
    f"https://github.com/aeon-toolkit/aeon-neuro/tree/{github_tag}/{current_file}"
)
nbsphinx_epilog = f"""
----
